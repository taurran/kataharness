...
| **COORDINATE** | `kata-orchestrate`, `kata-cursor`, `kata-tasklist`, `kata-worktree`, `kata-bootstrap`, `kata-readiness` | Plan-guardian assigns + partitions files; peers claim tasks, message laterally, isolate in worktrees |
...
> kata-cursor, kata-worktree, kata-tdd, kata-diagnose, kata-evaluate, kata-review, kata-handoff,
