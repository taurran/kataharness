...
| `kata-design-doc` | 0.3.0 | 2 | plan | beta | adapted-from mattpocock/skills {to-prd} + superpowers brainstorming + GSD spec-phase | Synthesize the frozen design doc / spec — dispatched as role `design-author` (KH-T13), gated by `protocol/authored-artifact-gate.md` before entering the main tree |
...
| `kata-plan-advanced` | 0.3.0 | 4 | plan | beta | adapted-from mattpocock/skills {to-issues vertical-slicing} + GSD plan-phase + BMAD {trade-offs-over-verdicts} + CPP plan format | Dispatched as role `plan-author` (KH-T13) once DESIGN.md is frozen, gated by `protocol/authored-artifact-gate.md` before entering the main tree |
| `kata-plan-essential` | 0.3.0 | 2 | plan | beta | adapted-from mattpocock/skills {to-issues vertical-slicing} + GSD plan-phase + BMAD {trade-offs-over-verdicts} + CPP plan format | Dispatched as role `plan-author` (KH-T13) once DESIGN.md is frozen, gated by `protocol/authored-artifact-gate.md` before entering the main tree |
| `kata-plan-standard` | 0.3.0 | 3 | plan | beta | adapted-from mattpocock/skills {to-issues vertical-slicing} + GSD plan-phase + BMAD {trade-offs-over-verdicts} + CPP plan format | Dispatched as role `plan-author` (KH-T13) once DESIGN.md is frozen, gated by `protocol/authored-artifact-gate.md` before entering the main tree |
